        ...
        val biometricPrompt = BiometricPrompt(this, executor,
            object : BiometricPrompt.AuthenticationCallback() {
                ...
                override fun onAuthenticationError(errorCode: Int, errString: CharSequence) {
                    ...
                    showError("Security Authentication Failed: $errString")
                }
                override fun onAuthenticationFailed() {
                    super.onAuthenticationFailed()
                    Log.w(TAG, "Biometric authentication failed attempt")
                }
            })

        val promptInfo = BiometricPrompt.PromptInfo.Builder()
            .setTitle("Agent Cypher Security Lock")
            .setSubtitle("Authenticate with Face Unlock, Fingerprint or PIN to access Cypher")
